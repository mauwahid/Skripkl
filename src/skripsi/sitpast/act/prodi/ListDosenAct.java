...
public class ListDosenAct extends GenericForwardComposer<Component>{
	...
	private void loadData(String query){
		...
		Criterion rest3 = Restrictions.eq("prodi", user.getProdi());
		Criterion rest4 = Restrictions.or(rest1, rest2);
		Criterion restTotal = Restrictions.or(rest3, rest4);
		
		criteria.add(restTotal);*/
		
		listDosen = sess.createQuery("select distinct dosen from Dosen as dosen" +
				" where dosen.prodi.id = "+user.getProdi().getId()).list();
